...
1. **Stripe Dashboard** — brand it, create Payment Link for $395, configure Invoicing reminders (custom domain `pay.roguenight.com.au` skipped — `buy.stripe.com` URL is fine)
